...
const ViewDetailsButton: React.FC<{ experimentId: number }> = ({ experimentId }) => {
    return (
        <Link to={`/experiment-results/${experimentId}`} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex items-center">
